...
public class DiceTest { // 주사위 던지기 1,2,3,4
    ...
    public static void dice3(int cnt, int start) { // cnt : 기존까지 던진 주사위 횟수, start : 시도할 수의 시작
        // 기저파트
        if (cnt == N) { // 다 던졌다면 ...
            ++totalCnt;
            System.out.println(Arrays.toString(numbers));
    ...
    public static void dice4(int cnt, int start) { // cnt : 기존까지 던진 주사위 횟수, start : 시도할 수의 시작
        // 기저파트
        if (cnt == N) { // 다 던졌다면 ...
            ++totalCnt;
            System.out.println(Arrays.toString(numbers));
